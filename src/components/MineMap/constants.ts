...
export const WD_SENSOR_POSITIONS: Record<string, SensorPosition> = {
  // ====== 斜向通道上部区域 (9个) ======
  WD010101: { x: 805, y: 155, zone: 4, type: "WD" }, // (790,140)
  WD010102: { x: 785, y: 185, zone: 4, type: "WD" }, // (770,170)
  WD010103: { x: 815, y: 185, zone: 4, type: "WD" }, // (800,170)
  WD010104: { x: 945, y: 165, zone: 4, type: "WD" }, // (930,150)
  WD010105: { x: 975, y: 155, zone: 4, type: "WD" }, // (960,140)
  WD010106: { x: 975, y: 185, zone: 4, type: "WD" }, // (960,170)
  WD010107: { x: 1195, y: 150, zone: 4, type: "WD" }, // (1180,135)
  WD010108: { x: 1175, y: 180, zone: 4, type: "WD" }, // (1160,165)
  WD010109: { x: 1205, y: 180, zone: 4, type: "WD" }, // (1190,165)

  // ====== L形分支中部区域 (4个) ======
  WD010201: { x: 1065, y: 395, zone: 5, type: "WD" }, // (1050,380)
  WD010202: { x: 1085, y: 415, zone: 5, type: "WD" }, // (1070,400)
  WD010203: { x: 1055, y: 425, zone: 5, type: "WD" }, // (1040,410)
  WD010204: { x: 1275, y: 385, zone: 5, type: "WD" }, // (1260,370)

  // ====== L形分支水平段 (1个) ======
  WD010301: { x: 1425, y: 425, zone: 5, type: "WD" }, // (1410,410)

  // ====== 底层左侧区域 (4个) ======
  WD010401: { x: 1256, y: 455, zone: 5, type: "WD" }, // (1241,440)
  WD010402: { x: 1286, y: 455, zone: 5, type: "WD" }, // (1271,440)
  WD010403: { x: 1316, y: 455, zone: 5, type: "WD" }, // (1301,440)
  WD010404: { x: 1346, y: 455, zone: 5, type: "WD" }, // (1331,440)

  // ====== 底层右侧区域 (3个) ======
  WD010501: { x: 1486, y: 455, zone: 5, type: "WD" }, // (1471,440)
  WD010502: { x: 1516, y: 455, zone: 5, type: "WD" }, // (1501,440)
  WD010503: { x: 1546, y: 455, zone: 5, type: "WD" }, // (1531,440)
};
...
export const FS_SENSOR_POSITIONS: Record<string, SensorPosition> = {
  // ====== 底层左侧 (5个) ======
  FS010101: { x: 1256, y: 505, zone: 5, type: "FS" }, // (1241,490)
  FS010102: { x: 1286, y: 505, zone: 5, type: "FS" }, // (1271,490)
  FS010103: { x: 1316, y: 505, zone: 5, type: "FS" }, // (1301,490)
  FS010104: { x: 1346, y: 505, zone: 5, type: "FS" }, // (1331,490)
  FS010105: { x: 1375, y: 505, zone: 5, type: "FS" }, // (1360,490)

  // ====== 底层右侧 (3个) ======
  FS010201: { x: 1486, y: 505, zone: 5, type: "FS" }, // (1471,490)
  FS010202: { x: 1516, y: 505, zone: 5, type: "FS" }, // (1501,490)
  FS010203: { x: 1546, y: 505, zone: 5, type: "FS" }, // (1531,490)
};
