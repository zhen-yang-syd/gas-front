...
interface CronbachCardProps {
  data: CronbachResult;
}

export function CronbachCard({ data }: CronbachCardProps) {
  ...
  return (
    <div className="bg-slate-900 rounded-lg p-3 border border-slate-700">
      {/* 标题 */}
      <div className="text-xs text-slate-400 mb-2">Cronbach&apos;s Alpha</div>
